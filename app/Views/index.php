...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>css/player.css">
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.1/dist/js/bootstrap.bundle.min.js"></script>
  <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
</head>
<body style="background-image:url(<?= base_url() ?>img/b1.jpg)">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/addToPlaylist" method="post" enctype="multipart/form-data">
          ...
          <div class="modal-footer">
            <button type="submit" class="btn btn-success" id="addToPlaylistModalSubmit">Add</button>
          </div>
        </form>
      </div>
    </div>
...
<div class="modal fade" id="createPlaylist" tabindex="-1" aria-labelledby="createPlaylistLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
      <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal">Back</button>
  ...
  <form action="/" method="get">
    ...
    <br><h1>Music Player</h1><br>
    <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal">
  Playlists
</button>

<button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addAudio">Add Music</button><br><br>
  <audio id="audio" controls autoplay></audio>
  <ul id="playlist">
      <?php foreach ($allAudio as $audio): ?>
        <li data-src='<?php echo base_url("music/" . $audio['audio']); ?>'>
          <?= $audio['audio'] ?>
            <button type="button" class="btn btn-success add-to-playlist" data-bs-toggle="modal" data-bs-target="#addToPlaylist" >
              +
            </button>
        </li>
      <?php endforeach; ?>
